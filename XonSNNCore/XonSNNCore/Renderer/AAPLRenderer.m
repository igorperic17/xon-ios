...
- (nonnull instancetype)initWithMetalKitView:(nonnull MTKView *)mtkView
{
    ...
    if(self)
    {
        ...
        id<MTLLibrary> defaultLibrary = [_device newDefaultLibraryWithBundle:frameworkBundle error:nil];
...
//                                                           withExtension:@"tga"];
        ...
        NSURL *imageFileLocation = [frameworkBundle URLForResource:@"initial-neuron-noise-2"
                                                           withExtension:@"tga"];
        ...
        [_outputTexture replaceRegion:region
                    mipmapLevel:0
...
#define VIEW_SIZE 500
    static const AAPLVertex quadVertices[] =
    {
        ...
        { {  VIEW_SIZE,  -VIEW_SIZE },  { 1.f, 1.f } },
        { { -VIEW_SIZE,  -VIEW_SIZE },  { 0.f, 1.f } },
        { { -VIEW_SIZE,   VIEW_SIZE },  { 0.f, 0.f } },

        { {  VIEW_SIZE,  -VIEW_SIZE },  { 1.f, 1.f } },
        { { -VIEW_SIZE,   VIEW_SIZE },  { 0.f, 0.f } },
        { {  VIEW_SIZE,   VIEW_SIZE },  { 1.f, 0.f } },
    };
